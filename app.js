...
const beUpAHello = new Album({
    artist: "Squarepusher",
    title: "Be Up A Hello",
    listen: "https://www.youtube.com/watch?v=ODtzaxx-ifc&list=OLAK5uy_lb3RkVZOSxQTx1XBHQ7PeAIzQ_Jd8AAjk&index=1"
});
  
const melee = new Album({
    artist: "Dogleg",
    title: "Melee",
    listen: "https://www.youtube.com/watch?v=_BrZUwzrvVI&list=PLNcHHgfUCHDaCKUReDsh6W8KDlQcdPmtT"
});
  
const noDream = new Album({
    artist: "Jeff Rosenstock",
    title: "NO DREAM",
    listen: "https://www.youtube.com/watch?v=T2UVigK4dA8&list=PL8M_6pUgzQuUySDUembnytFIYKskRzj_D"
});
